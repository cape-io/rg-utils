...
const prefixInfo = [
  ...
  {
    patternPrefix: 'dl', categoryId: TEXTILE, tag: PERFORMANCE, appCode: 'dl', patternMinNumber: 1000, patternSeparator: false,
  },
  ...
  {
    patternPrefix: 'dlt', categoryId: TRIM, tag: PERFORMANCE, appCode: 'dl', patternMinLength: 3, patternMinNumber: 100, patternSeparator: false,
  },
  { // This can be replaced with something else.
    patternPrefix: 'dll', categoryId: LEATHER, tag: PERFORMANCE, appCode: 'dl', patternMinNumber: 1000, patternSeparator: false,
  },
  {
    patternPrefix: 'pf', categoryId: TEXTILE, tag: PERFORMANCE, patternMinLength: 3, patternMinNumber: 1, patternSeparator: false,
  },
  {
    patternPrefix: 'pft', categoryId: TRIM, tag: PERFORMANCE, patternMinLength: 3, patternMinNumber: 100, patternSeparator: false,
  },
  {
    patternPrefix: 'pfi', categoryId: TEXTILE, tag: PERFORMANCE, patternMinNumber: 2000, patternSeparator: false,
  },
  {
    patternPrefix: 'rg', categoryId: TEXTILE, patternMinNumber: 1, patternMinLength: 3, patternSeparator: false,
  },

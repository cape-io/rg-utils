...
const prefixInfo = [
  ...
  {
    patternPrefix: 'dl', categoryId: TEXTILE, appCode: 'dl', patternMinNumber: 1000,
  },
  {
    patternPrefix: 'dli', categoryId: LINEN, appCode: 'dl', patternMinNumber: 2000,
  },
  {
    patternPrefix: 'dlt', categoryId: TRIM, appCode: 'dl', patternMinLength: 3, patternMinNumber: 100,
  },
  { // This can be replaced with something else.
    patternPrefix: 'dll', categoryId: LEATHER, appCode: 'dl', patternMinNumber: 1000,
  },
  {
    patternPrefix: 'pf', categoryId: TEXTILE, tag: PERFORMANCE, patternMinNumber: 1000,
  },
  {
    patternPrefix: 'pft', categoryId: TRIM, tag: PERFORMANCE, patternMinLength: 3, patternMinNumber: 100,
  },

...
// INVALID
export const isInvalid = (x) => (!x.patternId && !x.colorId) || x.otherId || !x.categoryId
...
export const isLeather = _.overSome([
  propDo('categoryId', _.flow(_.lowerCase, _.includes('leather'))),
...
export const isLinen = _.overSome([
  propDo('categoryId', _.flow(_.lowerCase, _.includes('linen'))),
  propDo('patternId', patternIsLinen),
])

// TEXTILE
export const isTextile = _.overSome([
  propDo('categoryId', _.flow(_.lowerCase, _.startsWith('texti'))),
...
export const isTrim = _.overSome([
  propDo('categoryId', isTrimCat),
  propDo('patternId', patternIsTrim),
])

// create getCategory. Use categoryId field before patternId field.
export const getCategory = ({ categories }) => _.cond([
  ...
  [_.stubTrue, _.flow(_.get('categoryId'), _.lowerCase)],
])

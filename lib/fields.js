...
export const fields = info.fields.map(setFieldWith('optCodeId', 'optIdCode', _.invert))
...
function optIdSearchReducer(result, [key, value]) {
  ...
  if (id === 'categoryId' && vals.length === 1) {
    return _.set('categoryId', _.first(vals), result)
  }

...
const PATTERN_INT_MAX = 9900099 // 2 ** PATTERN_RAW_BITS
export const COLOR_ID_ERROR = '97' // This is an error.
export const COLOR_ID_ERROR2 = '98' // Can't remember what this is for.
export const COLOR_ID_DEFAULT = '99' // Same as null?
...
export const ispatternInt = (x) => _.isFinite(x) && x >= PATTERN_MIN && x < PATTERN_INT_MAX
// Single color value.
...
// ITEM ID
// Join patternId with colorId to form itemId string. Old getPatternItemId().
...
export const fixItemId = _.flow(getIdParts, _.get('itemId'))

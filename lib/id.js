...
export const isPatternPart = _.overSome([isPatternPrefix, patternIsTextile])
...
export function getItemIdParts(str) {
  const result = itemIdObj(getPatternIdInfo(str))
  if (!hasValidIdChars(str)) result.invalid = true
  return result
}

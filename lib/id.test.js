import {
  getItemIdParts, getItemParts,
  hasValidIdFormat, idStrPrep, isPatternPart, isValidPattern,
...
describe('getItemParts', () => {
  test('split with no dash', () => {
    expect(getItemParts('dl710014')).toEqual(['dl', '710014'])
    expect(getItemParts('pf2001')).toEqual(['pf', '2001'])
  })
  test('split with dash', () => {
    expect(getItemParts('p-0010')).toEqual(['p', '0010'])
  })
})

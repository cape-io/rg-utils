...
export const getItem = _.curry((pattern, colorItem) => ({
  categoryId: pattern.category, // Only used to filter search results when slim.
  imagePath: normalImgPath(colorItem), // Only used to filter search results when slim.
  ...colorItem,
  pattern,
}))

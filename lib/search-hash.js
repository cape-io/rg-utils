...
export const addSearchFilter = searchFilterAdjust((vals, newVal) => _.union(vals, [newVal]))
export const rmSearchFilter = searchFilterAdjust((vals, newVal) => _.without([newVal], vals))

...
describe('searchHashEncode', () => {
  ...
  test('empty search', () => {
    expect(searchHashEncode(null)).toBe('any')
  })
  test('itemId + filters', () => {
    const search = {
      itemId: '91009-01',
...
describe('addSearchFilter', () => {
  test('add color', () => {
    expect(addSearchFilter(ANY_CAT, 'colors', 'pink')).toBe('cspk')

...
const COLORS = 'colors'
export const filterFieldsPaths = [COLORS, CONTENTS, DESIGNS]

export const searchFields = [
  'itemId', 'color',
  // Is there a way to search on the pattern first? Not sure it saves much actually.
  'pattern.categoryId', 'pattern.name', 'pattern.originCountry', // 'pattern.content',
  ...filterFieldsPaths,
]
export const storeFields = ['appCode', 'categoryId', 'imagePath', 'pattern.name', ...filterFieldsPaths]
